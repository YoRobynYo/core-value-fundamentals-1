...
<div class="helper-box">
  ...
  <div class="code-block">
    SET "students in class" = 25<br>
    SET "students absent" = 3<br>
    SET "students present" = "students in class" - "students absent"<br>
...
<div class="helper-box">
  ...
  <div class="code-block">
    ...
    SET "number of students" = 25     ✅ (clear — it's a count of students)<br>
  ...
  and joining the words together.</p>
...
<div class="helper-box">
  ...
  <strong>one line</strong> — and every message changes automatically:</p>
