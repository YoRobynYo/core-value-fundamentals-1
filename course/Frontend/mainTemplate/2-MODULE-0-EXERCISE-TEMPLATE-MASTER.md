...
**WHY:** Children must learn to convert natural language to a variable name themselves. This is a critical learning skill that applies to every language!
...
> **Note:** Naming conventions like camelCase or snake_case are NOT taught in Fundamentals. Children learn those when they pick a language. Here we only teach the concept of giving variables meaningful names.
