...
<div class="helper-box">
  ...
  can be approved, it must pass TWO checks: it must have the correct flavor AND it must
  ...
  <ul class="indented-list">
    <li>Is the flavor correct? <strong>AND</strong></li>
...
<div class="helper-box">
  ...
  <p>Let's check if a popcorn batch is ready for shipping. It needs the correct flavor
  AND enough bags:</p>

  <div class="code-block">
    SET "current flavor" = "Plain"<br>
    SET "required flavor" = "Plain"<br>
    SET "bags ready" = 25<br>
    SET "bags needed" = 20<br>
    <br>
    IF "current flavor" = "required flavor" AND "bags ready" >= "bags needed" THEN<br>
    &nbsp;&nbsp;PRINT "The flavor is correct and the quantity is enough: true"<br>
    ELSE<br>
    &nbsp;&nbsp;PRINT "The flavor is correct and the quantity is enough: false"<br>
    END IF
  </div>
  ...
  <ul class="indented-list">
    <li><strong>First check:</strong> Is "current flavor" equal to "required flavor"? (Is the flavor correct?)</li>
  ...
  <div class="code-block">
    <!-- Example 1: Both true -->
    Flavor correct: true<br>
    Quantity enough: true<br>
    Result: true ✅ (Batch approved!)<br>
    <br>
    <!-- Example 2: Flavor wrong, quantity enough -->
    Flavor correct: false<br>
    Quantity enough: true<br>
    Result: false ❌ (Wrong flavor!)<br>
    <br>
    <!-- Example 3: Flavor correct, quantity not enough -->
    Flavor correct: true<br>
    ...
    Flavor correct: false<br>
    Quantity enough: false<br>
    Result: false ❌ (Wrong flavor AND not enough bags!)
  </div>
...
<div class="helper-box">
  ...
  <p>A batch must have: Correct flavor AND enough quantity AND proper packaging</p>
  <div class="code-block">
    IF flavor is correct AND quantity is enough AND packaging is proper THEN<br>
...
<div class="helper-box">
  ...
  <p>We need to check if the Plain Popcorn station has the correct flavor AND
  ...
  <p class="output">Output: The flavor is correct and the quantity is enough: true</p>

  <h4 class="sub-title">Scenario 2: Buttery Popcorn Check</h4>

  <p>Now we need to check if the Buttery Popcorn has the correct flavor AND
  is still fresh (made within the freshness limit):</p>

  <div class="code-block">
    SET "current flavor" = "Buttery"<br>
    SET "required flavor" = "Buttery"<br>
    SET "hours since made" = 2<br>
    SET "freshness limit in hours" = 4<br>
    <br>
    IF "current flavor" = "required flavor" AND "hours since made" <= "freshness limit in hours" THEN<br>
    &nbsp;&nbsp;PRINT "The flavor is correct and the popcorn is fresh: true"<br>
    ELSE<br>
    &nbsp;&nbsp;PRINT "The flavor is correct and the popcorn is fresh: false"<br>
    END IF
  </div>
  <p class="output">Output: The flavor is correct and the popcorn is fresh: true</p>

  <h4 class="sub-title">Scenario 3: When One Condition Fails</h4>

  <p>What happens when the flavor is correct BUT there aren't enough bags?</p>
  ...
  <p class="output">Output: The flavor is correct and the quantity is enough: false</p>

  <p>Even though the flavor is correct, there aren't enough bags. With AND,
  BOTH must be true!</p>

  <p class="note">💡 <strong>Practice tip:</strong> Try changing the numbers in your
...
## HELPER BOX 5: YOUR FIRST AND PRACTICE 🧪

```html
<!-- Helper Box 5: Your First AND Practice -->
<div class="helper-box">
  <h3 class="box-title">🧪 Your First AND Practice 🧪</h3>

  <p>Now it's your turn to practice using the AND operator! Let's try some
  simple examples before you do the exercises.</p>

  <h4 class="sub-title">Practice Example 1: Library Book</h4>
  ...
  <h4 class="sub-title">Practice Example 2: Rainy Day</h4>
  ...
  <h4 class="sub-title">Practice Example 3: Game Level</h4>
  ...
  <ul class="indented-list">
    ...
    <li><strong>Factory quality control</strong> — flavor AND quantity AND freshness</li>
  </ul>
