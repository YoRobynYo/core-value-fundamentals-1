...
- [ ] Section name is "pirateAdventure"
...
- [ ] IDs follow pattern: pirateAdventure-ex[number]-part-[letter]
- [ ] Data attributes correct: data-section="pirateAdventure"
