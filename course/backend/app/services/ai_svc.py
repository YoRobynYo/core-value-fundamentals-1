...
#                 if response.status_highlight == 200:
...
#                     return resp
#                 else:
#                     logger.error(f"Ollama error: {response.status_highlight} - {response.text[:100]}")
...
#                 else:
#                     logger.error(f"Ollama error: {response.status_highlight}")
#                     return "AI service temporarily unavailable"
